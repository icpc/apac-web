    ...
    <div className="mb-20 md:mb-12">
      ...
      >
        ...
        <WideContainer className={`${styles.content} flex flex-col py-36 lg:py-48 lg:py-0 lg:flex-row items-center justify-between lg:row-span-3`}>
          ...
          <img src={`/assets/icpc-apac-logo/icpc-apac-logo-new-solid-${dark ? "white" : "blue"}.png`} alt="ICPC APAC Logo" className="w-2/3 max-w-[300px] pb-12 md:w-1/3 order-1 lg:order-2 lg:pb-0" />
        </WideContainer>
